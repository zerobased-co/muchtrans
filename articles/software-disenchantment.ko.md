...
[“같은 곳에 있으려면 쉬지 않고 힘껏 달려야 해”](https://en.wikipedia.org/wiki/Red_Queen%27s_race). 그런데 무슨 소용이 있죠? 내 옆 사람처럼 가끔 새 전화기와 새 맥북을 사면서 즐거울 수도 있겠지만, 그래서 할 수 있는 일이라는 게 그저 똑같지만 더 느려진 앱을 실행하는 것뿐인데요?
